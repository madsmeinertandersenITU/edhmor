...
public class VispApriltagDetection extends JFrame {
    static {
    ...
    public VispApriltagDetection() {
        ...
        openButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int returnVal = fc.showOpenDialog(VispApriltagDetection.this);
