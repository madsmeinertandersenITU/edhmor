...
public class CoppeliaSimTest {
    ...
    private static CoppeliaSimCapture ImageCapture;
    private static AprilTagDetector aprilTagDetector;

    public static void main(String[] args) {
    	
    	//Uncomment to get the image from the CoppeliaSim
        ImageCapture = new CoppeliaSimCapture((CoppeliaSimulator) null, "Vision_sensor_arena");
    	ImageCapture.connect2CoppeliaSim();
    	...
    	//ImageCapture = new Capture(0);
    	//ImageCapture.captureCameraImage();
       
    	
    	VpImageIo.write(ImageCapture.getI(),"C:/visp-ws/visp-build-vc16/example/calibration/Release/CoppeliaSim/chessboard-06.jpg");
