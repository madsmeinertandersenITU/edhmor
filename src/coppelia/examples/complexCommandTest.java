...
public class complexCommandTest
{
    public static void main(String[] args)
    {
        ...
        int clientID = coppeliaSimApi.simxStart("127.0.0.1",19999,true,true,5000,5);
        if (clientID!=-1)
        {
            ...
            int result=coppeliaSimApi.simxCallScriptFunction(clientID,"remoteApiCommandServer",coppeliaSimApi.sim_scripttype_childscript,"displayText_function",null,null,inStrings,null,null,null,outStrings,null,coppeliaSimApi.simx_opmode_blocking);
            if (result==coppeliaSimApi.simx_return_ok)
            ...
            result=coppeliaSimApi.simxCallScriptFunction(clientID,"remoteApiCommandServer",coppeliaSimApi.sim_scripttype_childscript,"createDummy_function",null,inFloats,inStrings,null,outInts,null,null,null,coppeliaSimApi.simx_opmode_blocking);
            if (result==coppeliaSimApi.simx_return_ok)
            ...
            + "return 'done'";
            result=coppeliaSimApi.simxCallScriptFunction(clientID,"remoteApiCommandServer",coppeliaSimApi.sim_scripttype_childscript,"executeCode_function",null,null,inStrings,null,null,null,outStrings,null,coppeliaSimApi.simx_opmode_blocking);
            if (result==coppeliaSimApi.simx_return_ok)
