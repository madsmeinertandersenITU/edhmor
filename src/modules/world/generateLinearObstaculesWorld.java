 ...
 * @author fai
 */
public class generateLinearObstaculesWorld {
    ...
    File file = new File("./linearObstaculesWorld.world");
    file.delete();
    int nObstaculos = 6;
    double anchoObstaculo=0.1, maxObstaculoZ = 0.30, minObstaculoZ = 0.05;
    double maxZoneX = 18, minZoneX=2, maxZoneY=4, minZoneY=-4;
    double obstaculosCadaXMetros = (maxZoneX - minZoneX)/(nObstaculos-1);
        ...
        try {
            ...
            config.addProperty("PropiedadesMundoRugoso.anchoObstaculo" + "(-1)", anchoObstaculo);
            config.addProperty("PropiedadesMundoRugoso.maxDimensionesBoxZ" + "(-1)", maxObstaculoZ);
            config.addProperty("PropiedadesMundoRugoso.minDimensionesBoxZ" + "(-1)", minObstaculoZ);
            ...
            for (int m = 0; m < nObstaculos; m++) {
                ...
                x = minZoneX + m*obstaculosCadaXMetros;
                y = 0;
                z = minObstaculoZ + (maxObstaculoZ - minObstaculoZ)/nObstaculos * m;
