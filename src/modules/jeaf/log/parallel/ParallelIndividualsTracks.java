 ...
 * @author fai
 */
public class ParallelIndividualsTracks extends ParallelIndividualsLogs {
            ...
            if (algorithm.getState() == EvolutionaryAlgorithm.REPLACE_STATE) {
                ...
                for (Individual i : individuals) {
                    ...
                    if (t.getOperation() != null)
                        srtOp = t.getOperation().toString();
                    super.getLog(count).println("OPERATION: " + srtOp + "\n");
    ...
    public String getLogID() {
        return "parallelindividualstracks";
    }
}
