 ...
 * @since 1.0
 */
public class ParallelBestMeanWallTimeFELogTool extends ParallelLogTool {

    public ParallelBestMeanWallTimeFELogTool() {
    }  

    @Override
    public String getLogID() {
        return "ParallelBestMeanWallTimeFELogTool";
    }
