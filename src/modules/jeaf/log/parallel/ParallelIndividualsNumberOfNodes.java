 ...
 * @author fai
 */
public class ParallelIndividualsNumberOfNodes extends ParallelIndividualsLogs{
        ...
        if (pea.getCurrentObservable() instanceof EvolutionaryAlgorithm) {
            ...
            if (algorithm.getState() == EvolutionaryAlgorithm.SELECT_STATE) {
                ...
                for (Individual i : individuals) {
                    TreeIndividual treeInd = (TreeIndividual) i;
                    super.getLog(count).println( algorithm.getGenerations()  + " - " + treeInd.getRootNode().getNumberModulesBranch() );
                    count++;
                }
            }
        }
    ...
    public String getLogID() {
        return "ParallelIndividualsNumberOfNodes";
    }
