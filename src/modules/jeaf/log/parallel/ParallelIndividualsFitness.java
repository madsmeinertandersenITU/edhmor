 ...
 * @author fai
 */
public class ParallelIndividualsFitness extends ParallelIndividualsLogs {
        ...
        if (pea.getCurrentObservable() instanceof EvolutionaryAlgorithm) {
            ...
            if (algorithm.getState() == EvolutionaryAlgorithm.SELECT_STATE) {
                ...
                for (Individual i : individuals) {
                    super.getLog(count).println( algorithm.getGenerations()  + " - " + i.getFitness() );
                    count++;
                }
            }
        }
    ...
    public String getLogID() {
        return "parallelindividualsfitness";
    }
