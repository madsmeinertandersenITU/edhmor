 ...
 * @author fai
 */
public class ChangeOrientation extends MutationOperation {

    @Override
    public void run(TreeIndividual arbol) {
        //Elegimos el nodo a cambiar de orientacion
        ...
        if (toChange != null) {
            ...
            dad.changeOrientation(toChange);
    ...
    public void repair(TreeIndividual arbol) {
        ...
        //Cambiar de orientación el nodo aumento el fitness
