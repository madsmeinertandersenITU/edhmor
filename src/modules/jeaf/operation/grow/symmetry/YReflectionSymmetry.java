 ...
 * @author fai
 */
public class YReflectionSymmetry extends SymmetryOperator {

    public YReflectionSymmetry() {
        super();
    }

    @Override
    protected Node getBranchToDoSymmetry(TreeIndividual tree) {
        return getBranchToDoYReflectionSymmetry(tree) ; 
    }

    protected Node getBranchToDoYReflectionSymmetry(TreeIndividual tree) {
        ...
        for (Node child : rootNode.getChildren()) {
            ...
            boolean canDoSymmetry = SymmetryTools.canSymmetryBeApplied_YReflection(v);
    ...
    public String toString() {
        String str = "YReflectionSymmetry";
        if (this.isWorking()) {
            str += "   (isWorking)";
        } else {
            str += "   (NOT Working)";
