...
/**
 * XSymmetryEvaluator is class to calculate the symmetry around the plane XZ.
 * <p>
 * This class implements the evaluation of the symmetry of an individual 
 * using the methods provided in SymmetryFeature. 
 * 
 * XSymmetryEvaluator.java Created on 01/09/2020
 *
 * @author Andres Faiña <anfv  at itu.dk>
 */
public class XSymmetryEvaluator extends SymmetryFeature {
    ...
    protected boolean canSymmetryBeApplied(Vector3D a) {
        return SymmetryTools.canSymmetryBeApplied_XReflection(a);
    }
}
