...
public class TestController extends RobotController {
    ...
    public TestController(remoteApi api, int clientID, CoppeliaSimCreateRobot robot) {
        ...
        for (int module = 0; module < moduleHandlers.size(); module++) {
            ...
            if (module != 3) {
                if (isObjectDetected) {
                    ...
                    if (!isModule1PositionSet && !areFloatsEqual(module1Position, jointTargetPosition)) {
