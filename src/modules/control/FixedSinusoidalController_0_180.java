 ...
 */
public class FixedSinusoidalController_0_180 extends SinusoidalController {

    
            
    public FixedSinusoidalController_0_180(remoteApi api, int clientID, CoppeliaSimCreateRobot robot) {
