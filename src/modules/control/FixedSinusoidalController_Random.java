 ...
 */
public class FixedSinusoidalController_Random extends SinusoidalController {

    
            
    public FixedSinusoidalController_Random(remoteApi api, int clientID, CoppeliaSimCreateRobot robot) {
        ...
        for (int module = 0; module < moduleHandlers.size(); module++) {
            ...
            phaseControl[module] = EAFRandom.nextInt(360);
