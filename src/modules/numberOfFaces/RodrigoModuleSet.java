 ...
 * @author fai
 */
public class RodrigoModuleSet extends ModuleSet {

    /*Constructor for the RodrigoModuleSet class*/
    public RodrigoModuleSet() {
     ...
     */
    public RodrigoModuleSet(int modulesTypeNumber, int maxFaceNumberInOneModule, int maxOrientations) {
