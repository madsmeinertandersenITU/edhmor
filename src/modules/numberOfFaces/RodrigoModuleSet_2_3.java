 ...
 * @author 
 */
public class RodrigoModuleSet_2_3 extends ModuleSet {
     ...
     */
    public RodrigoModuleSet_2_3() {
        //two types of module with three connection faces and 2 orientations
        super(2, 3, 4);
        ...
        modulesFacesNumber[0] = 2; //Number of faces for base module
        modulesFacesNumber[1] = 3;//Number of faces for Rodrigo´s module
        ...
        originFaceVector[0][0] = new Vector3D(0.008, 0.0305, 0);  //Face 2
        originFaceVector[0][1] = new Vector3D(0.008, -0.0305, 0);  //Face 3
        
        //Rodrigo´s module
        originFaceVector[1][0] = new Vector3D(-0.0385, 0, 0);   //Face 0
        originFaceVector[1][1] = new Vector3D(0.008, 0, 0.0305);  //Face 2
        originFaceVector[1][2] = new Vector3D(0.008, 0, -0.0305);  //Face 3
        ...
        normalFaceVector[0][0] = new Vector3D(0, 1, 0);    //Face 2
        normalFaceVector[0][1] = new Vector3D(0, -1, 0);     //Face 3
        
        //Rodrigo´s module
        normalFaceVector[1][0] = new Vector3D(-1, 0, 0);     //Face 0
        normalFaceVector[1][1] = new Vector3D(0, 0, 1);    //Face 2
        normalFaceVector[1][2] = new Vector3D(0, 0, -1);     //Face 3
