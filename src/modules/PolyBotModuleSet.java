...
public class PolyBotModuleSet extends ModuleSet {

	public PolyBotModuleSet() {
		// 1 types of module with 2 connection faces and 2 orientations
		this(1, 2, 2);
	}

	public PolyBotModuleSet(int modulesTypeNumber, int maxFaceNumberInOneModule, int maxOrientations) {
		...
		// polybot g2 module
		originFaceVector[0][0] = new Vector3D(-0.03, 0, 0); // Face 0
		originFaceVector[0][1] = new Vector3D(0.03, 0, 0); // Face 1
		...
		// polybot g2 module
		boundingBox[0] = new Vector3D(0.06, 0.11, 0.05);
