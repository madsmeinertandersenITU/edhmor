 ...
 * @author fai
 */
public class OldEdhmorModuleSet extends EdhmorModuleSet {

    public OldEdhmorModuleSet() {
        ...
        moduleSetName = "oldEdhmorModules";
        ...
        connectionFaceForEachOrientation[1][1] = 1;        //connected in face 1
        connectionFaceForEachOrientation[1][2] = 1;        //connected in face 1
        connectionFaceForEachOrientation[1][3] = 1;        //connected in face 1
        connectionFaceForEachOrientation[1][4] = 1;        //connected in face 1
        connectionFaceForEachOrientation[1][5] = 10;      //connected in face 10
        connectionFaceForEachOrientation[1][6] = 10;      //connected in face 10
        
        rotationAboutTheNormalForEachOrientation[1][0] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[1][1] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[1][2] = Math.PI*0.5;//90 degrees
        rotationAboutTheNormalForEachOrientation[1][3] = Math.PI;    //180 degrees
        rotationAboutTheNormalForEachOrientation[1][4] = Math.PI*1.5;//270 degrees
        rotationAboutTheNormalForEachOrientation[1][5] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[1][6] = Math.PI*0.5;//90 degrees
 
        //telescopic module
        connectionFaceForEachOrientation[2][0] = 0;        //connected in face 0
        connectionFaceForEachOrientation[2][1] = 1;        //connected in face 1
        connectionFaceForEachOrientation[2][2] = 1;        //connected in face 1
        connectionFaceForEachOrientation[2][3] = 1;        //connected in face 1
        connectionFaceForEachOrientation[2][4] = 1;        //connected in face 1
        
        rotationAboutTheNormalForEachOrientation[2][0] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[2][1] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[2][2] = Math.PI*0.5;//90 degrees
        rotationAboutTheNormalForEachOrientation[2][3] = Math.PI;    //180 degrees
        rotationAboutTheNormalForEachOrientation[2][4] = Math.PI*1.5;//270 degrees
        
        //rotational module
        connectionFaceForEachOrientation[3][0] = 0;        //connected in face 0
        connectionFaceForEachOrientation[3][1] = 1;        //connected in face 1
        connectionFaceForEachOrientation[3][2] = 1;        //connected in face 1
        connectionFaceForEachOrientation[3][3] = 1;        //connected in face 1
        connectionFaceForEachOrientation[3][4] = 1;        //connected in face 1
        
        rotationAboutTheNormalForEachOrientation[3][0] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[3][1] = 0;          //0 degrees
        rotationAboutTheNormalForEachOrientation[3][2] = Math.PI*0.5;//90 degrees
        rotationAboutTheNormalForEachOrientation[3][3] = Math.PI;    //180 degrees
        rotationAboutTheNormalForEachOrientation[3][4] = Math.PI*1.5;//270 degrees
        ...
        //Hinge module
        originFaceVector[4][0] = new Vector3D(-0.1, 0, 0);
        originFaceVector[4][1] = new Vector3D(0.1, 0, 0);
        ...
        //Base module:
        boundingBox[0] = new Vector3D(1,0.1,1);
        
        //Slider module
        boundingBox[1] = new Vector3D(0.1,0.1,1);
        
        //Telescopic module
        boundingBox[2] = new Vector3D(0.1,0.1,0.8);
        
        //Rotational module
        boundingBox[3] = new Vector3D(0.1,0.1,0.2);
        
        //Hinge module
        boundingBox[4] = new Vector3D(0.1,0.1,0.2);
        
        //End effector module
        boundingBox[5] = new Vector3D(0.066,0.057,0.018);
